...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ModelBase', fields ['state']
        db.create_index(u'jmbo_modelbase', ['state'])


    def backwards(self, orm):
        # Removing index on 'ModelBase', fields ['state']
        db.delete_index(u'jmbo_modelbase', ['state'])
