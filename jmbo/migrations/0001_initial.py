# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-05-25 13:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('photologue', '0011_auto_20160525_1456'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ModelBaseImages',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('position', models.PositiveIntegerField(default=0)),
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='image_link_to_modelbase', to='photologue.Photo')),
        ...
        migrations.AddField(
            ...
            name='images',
            field=models.ManyToManyField(blank=True, null=True, through='jmbo.ModelBaseImages', to='photologue.Photo'),
        ),
        migrations.AddField(
            model_name='modelbase',
            name='owner',
