# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-05-23 07:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('photologue', '0011_auto_20160523_0956'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effect', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='imageoverride_related', to='photologue.PhotoEffect', verbose_name='effect')),
                ('photosize', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='photologue.PhotoSize')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view_count', models.PositiveIntegerField(default=0, editable=False, verbose_name='view count')),
                ('crop_from', models.CharField(blank=True, choices=[(b'top', 'Top'), (b'right', 'Right'), (b'bottom', 'Bottom'), (b'left', 'Left'), (b'center', 'Center (Default)')], default=b'center', max_length=10, verbose_name='crop from')),
                ('state', models.CharField(blank=True, choices=[(b'unpublished', b'Unpublished'), (b'published', b'Published'), (b'staging', b'Staging')], db_index=True, default=b'unpublished', editable=False, help_text="Set the item state. The 'Published' state makes the item visible to the public, 'Unpublished' retracts it and 'Staging' makes the item visible on staging instances.", max_length=32, null=True)),
                ('publish_on', models.DateTimeField(blank=True, db_index=True, help_text="Date and time on which to publish this item (state will change to 'published').", null=True)),
                ('retract_on', models.DateTimeField(blank=True, db_index=True, help_text="Date and time on which to retract this item (state will change to 'unpublished').", null=True)),
                ...
                ('description', models.TextField(blank=True, db_index=True, help_text='A short description. More verbose than the title but limited to one or two sentences.', null=True)),
                ...
                ('image_attribution', models.CharField(blank=True, help_text='Attribution for the canonical image, eg. Shutterstock.', max_length=256, null=True)),
                ...
                ('categories', models.ManyToManyField(blank=True, help_text='Categorizing this item.', null=True, to='category.Category')),
                ...
                ('primary_category', models.ForeignKey(blank=True, help_text="Primary category for this item. Used to determine the             object's absolute/default URL.", null=True, on_delete=django.db.models.deletion.CASCADE, related_name='primary_modelbase_set', to='category.Category')),
                ('sites', models.ManyToManyField(blank=True, help_text='Makes item eligible to be published on selected sites.', null=True, to='sites.Site')),
                ('tags', models.ManyToManyField(blank=True, help_text='Tag this item.', null=True, to='category.Tag')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='target',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='jmbo.ModelBase'),
        ),
