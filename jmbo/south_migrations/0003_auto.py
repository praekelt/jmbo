...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ModelBase', fields ['publish_on']
        db.create_index('jmbo_modelbase', ['publish_on'])

        # Adding index on 'ModelBase', fields ['retract_on']
        db.create_index('jmbo_modelbase', ['retract_on'])


    def backwards(self, orm):
        # Removing index on 'ModelBase', fields ['retract_on']
        db.delete_index('jmbo_modelbase', ['retract_on'])

        # Removing index on 'ModelBase', fields ['publish_on']
