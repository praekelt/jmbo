...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ModelBase', fields ['created']
        db.create_index('jmbo_modelbase', ['created'])

        # Adding index on 'ModelBase', fields ['modified']
        db.create_index('jmbo_modelbase', ['modified'])


    def backwards(self, orm):
        # Removing index on 'ModelBase', fields ['modified']
        db.delete_index('jmbo_modelbase', ['modified'])

        # Removing index on 'ModelBase', fields ['created']
