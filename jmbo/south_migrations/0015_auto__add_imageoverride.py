...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageOverride'
        db.create_table(u'jmbo_imageoverride', (
        ...
        db.send_create_signal(u'jmbo', ['ImageOverride'])


    def backwards(self, orm):
        # Deleting model 'ImageOverride'
        db.delete_table(u'jmbo_imageoverride')
